...
The $\mathtt{R}$-package $\mathtt{conogive}$ is the companion $\mathtt{R}$-package of this paper, available at \texttt{CRAN} and the Github repository \url{https://github.com/JonasMoss/conogive}. It can used to calculate concrete ordinal reliabilities. 
\begin{itemize}
