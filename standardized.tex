...
\begin{figure}
	...
	\subfigure[Beta distribution]{\includegraphics[width=0.46\textwidth]{plots/beta}}
	\subfigure[Gamma distribution]{\includegraphics[width=0.46\textwidth]{plots/gamma}}
