...
\end{thm}    
\begin{proof}
See page \pageref{proof:asymptotics} of Appendix 1 for a proof of (i) and (iii), and Appendix 2 (p. \pageref{appendix 2}) for a proof of (ii). \citet{Raykov2019-tv} is an introduction to convergence with probability $1$ in the psychometry context and contains a proof of (i) for coefficient alpha. The proofs of (ii) and (iii) rely heavily on the work of \citet{Van_Zyl2000-si} and \citet{hayashi2005note}.  \citet[][eq. 13]{Van_Zyl2000-si} and \citet[][eq. 58]{Kristof1963-tb}, among others, derived the limit distribution of coefficient alpha under the normal parallel model.
\end{proof}
