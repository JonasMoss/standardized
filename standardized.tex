...
\end{prop}
\begin{proof}
The relationship between the squared correlation and the reliability is classical. The equality involving the $\textsc{MSE}$ is a new observation as far as I know. See the appendix, page \pageref{proof:reliability motivation}.
\end{proof}
...
% of Proposition \ref{prop:Properties of three}. For $\omega_{s}>\omega$
% under the $\tau$-equivalent model by Proposition \ref{prop:Properties of three} and $\alpha = \omega$ under the $\tau$-equivalent model. Then it seems reasonable to use standardized alpha together with the sum scores. After all, standardized alpha
